...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/wosnxn123/fuwari", // Internal links should not include the base path, as it is automatically added
...
//		},
		{
			...
			url: "https://github.com/wosnxn123/fuwari",
			},
       {
            name: 'QQ',
            icon: 'fa6-brands:qq',
